            ...
            <main
                ...
                <div className=" absolute top-10 h-[calc(100%-50px)] w-full overflow-y-scroll p-3">
                    ...
                    <form action="" onSubmit={ContactUs}  className="mt-5  grid grid-cols-1 w-full" ref={form}>
                        ...
                        <motion.button
                            whileHover={{ backgroundColor: "oklch(88.2% 0.059 254.128)" }}
                            whileTap={{backgroundColor:"oklch(88.2% 0.059 254.128)"}}
                            className="flex items-center justify-center gap-2 mt-2.5  p-3 rounded-2xl text-2xl overflow-x-hidden  bg-blue-50 ">
                ...
                {alert && (
                    <Alert
                        className="absolute top-0 left-1/2 -translate-x-1/2 z-30 w-fit"
                        severity="warning"
                    >
